...
export default function AboutPage() {
  return (
    <div className="max-w-4xl mx-auto px-6 py-10 pt-20">
      <h1 className="text-3xl font-bold mb-4">About HackHarvard</h1>
      <p className="text-gray-700 mb-6">
        HackHarvard is a student-built project showcasing a lightweight interactive map and
        small web UI built during HackHarvard. The goal is to prototype ideas quickly and
        demonstrate basic navigation and interactive overlays.
      </p>

      <section className="mb-6">
        <h2 className="text-xl font-semibold mb-2">What we built</h2>
        <ul className="list-disc list-inside text-gray-700">
          <li>Persistent map anchored in the app layout</li>
          <li>City overlays that show additional information</li>
      ...
      <section className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700">
          ...
          <li>Avery Li - University of Virginia</li>
