export const cities = [
    ...
    },
    {
        ...
        color: "blue",
        description:
            "Coquimbo has experienced tsunami threats following large offshore Chilean earthquakes that send long-period waves into its bays. In some events shoreline flooding damaged piers, low coastal infrastructure, and seaside neighborhoods; boats were sometimes tossed ashore and sediment shifted navigation channels. Local economies tied to fishing and tourism can suffer when ports are out of service and shoreline amenities are damaged. These events repeatedly remind authorities about port vulnerability and the need for rapid response.\n\nMitigation blends Chile's strong seismic monitoring and public preparedness. Alerting systems and clear evacuation routes direct residents inland promptly after warnings. Coastal engineering—revetments, port redesign, and localized seawalls—reduces wave runup at vulnerable spots, while harbor authorities maintain contingency plans for clearing debris and restoring navigation channels. Officials now perform rapid port assessments and temporary mooring to limit damage after waves, and drills include fishermen and businesses; zoning keeps new construction away from exposed shorelines and maintain recovery stockpiles.",
